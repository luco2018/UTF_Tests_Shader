...
Shader "FTPCustom/Instancing/Unlit float2"
{
	Properties
	{
...
#define _Float2_arr MyProperties
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = tex2D(_MainTex, i.uv) * float4(UNITY_ACCESS_INSTANCED_PROP (_Float2_arr, _Float2),0,1);
