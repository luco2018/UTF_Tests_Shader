...
Shader "FTPCustom/Instancing/Unlit int2"
{
	Properties
	{
...
#define _Int2_arr MyProperties
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = tex2D(_MainTex, i.uv) * int4(UNITY_ACCESS_INSTANCED_PROP (_Int2_arr, _Int2),0,1);
