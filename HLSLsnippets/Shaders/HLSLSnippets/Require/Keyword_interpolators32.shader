Shader "FTPCustom/HLSLSnippets/Keyword interpolators32"
{
	Properties
	{
		[Toggle(ENABLE_INP32)] _Fancy("interpolators32?", Float) = 1
		...
		Pass
	{
		CGPROGRAM
		//#pragma target 4.5
		#pragma require interpolators32 : ENABLE_INP32
		#pragma shader_feature __ ENABLE_INP32
		#pragma vertex vert
	...
	v2f vert(appdata v)
	{
		...
		#if defined (SHADER_REQUIRE_INTERPOLATORS32)
			o.uv32 = TRANSFORM_TEX(v.uv, _MainTex);
		#endif
		return o;
	}
