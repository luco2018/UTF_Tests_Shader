...
public class MiniProfiler : MonoBehaviour
{
	...
	RecorderEntry[] recordersList = {
		...
		new RecorderEntry() { name="Render.OpaqueGeometry" },
		new RecorderEntry() { name="Render.TransparentGeometry" },
		new RecorderEntry() { name="Culling" },
		new RecorderEntry() { name="BehaviourUpdate" },
	};
