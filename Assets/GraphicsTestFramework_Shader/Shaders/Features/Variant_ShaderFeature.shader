...
Shader "FTPCustom/Feature/Variant ShaderFeature"
{
Properties 
{
...
Category 
{
	...
	SubShader 
	{
		Pass 
		{
			...
			#pragma shader_feature INPUT_COLOR_CHANGE
			#pragma shader_feature INPUT_COLOR_MULTIPLY
			#pragma shader_feature INPUT_COLOR_ADDITIVE
			#pragma shader_feature INPUT_COLOR_BLEND
